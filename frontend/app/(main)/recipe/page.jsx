  ...
  useEffect(() => {
    if (recipeData?.success) {
      console.log("📥 Recipe data received:", {
        ...
        description: recipeData.recipe.description?.substring(0, 50),
        ...
        fromDatabase: recipeData.fromDatabase,
      });
        ...
        <div className="mb-8">
          ...
          <div className="bg-white p-8 md:p-10 border-2 border-stone-200 mb-6">
            ...
            {recipe.imageUrl ? (
              ...
              <div className="w-full h-72 bg-gradient-to-br from-orange-100 to-amber-100 overflow-hidden mb-7 flex items-center justify-center border-2 border-orange-200">
            ...
            {/* Description */}
            <p className="text-lg text-stone-600 mb-6 font-light min-h-[24px] leading-relaxed">
              {recipe.description && recipe.description.trim().length > 0
                ? recipe.description
                : "Delicious recipe to enjoy. Add a description to make it more appealing!"}
            </p>
